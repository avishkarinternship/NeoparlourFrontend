...
export default function OwnerTermsAndConditions() {
    ...
    const content = {
        ...
        hi: {
            ...
            title: "सलून पार्टनर समझौता",
            brandInfo: "ब्रांड नाम: नियोपार्लर | कंपनी: नियोपेस इन्फोटेक एलएलपी",
            version: "संस्करण: 1.0",
            effective: "प्रभावी: 27/मई/2026",
            printBtn: "प्रिंट / पीडीएफ सहेजें",
            importantNotice: "महत्वपूर्ण : यह एक बी2बी वाणिज्यिक समझौता है। ऑनबोर्डिंग के दौरान इस समझौते को स्वीकार करके, आप सभी नियमों से सहमत होते हैं। ग्राहक आपको सीधे सलून में भुगतान करते हैं। प्लेटफॉर्म आपको कमीशन के लिए अलग से चालान जारी करता है।",
            searchPlaceholder: "दस्तावेज़ अनुभाग या कीवर्ड खोजें (जैसे, जीएसटी, कमीशन, एसएलए)...",
      ...
      sec11_1: "11.1 प्लेटफॉर्म के बाहर बुकिंग न कराएं।",
        ...
        mr: {
            b2bBadge: "बी२बी व्यावसायिक करार",
            title: "सलून पार्टनर करार",
            ...
            importantNotice: "महत्त्वाचे : हा बी२बी व्यावसायिक करार आहे. ऑनबोर्डिंगदरम्यान हा करार स्वीकारून, तुम्ही सर्व अटींशी सहमत होता. ग्राहक तुम्हाला थेट सलूनमध्ये पेमेंट करतात. प्लॅटफॉर्म तुम्हाला कमिशनसाठी स्वतंत्रपणे इनव्हॉइस पाठवतो.",
            searchPlaceholder: "दस्तऐवज विभाग किंवा शब्द शोधा (उदा. जीएसटी, कमिशन, एसएलए)...",
