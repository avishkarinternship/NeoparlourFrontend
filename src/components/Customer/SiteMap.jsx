  ...
  const sitemapData = [
    {
      title: "All Pages",
      items: [
        { name: "Testimonials", path: "/customer/client-testimonials" }, 
        { name: "Support", path: "/customer/support" },
        { name: "Help Centre", path: "/customer/support" },
        { name: "Contact Us", path: "/customer/support" },
        { name: "Security", path: "/customer/security" },
        { name: "Partner With Us", path: "/customer/partner-with-us" },
        { name: "About Us", path: "/customer/about" },
    ...
    },
    {
      title: "Features",
      items: [
        { name: "Appointment Management", path: "/customer/features" },
        { name: "Membership", path: "/customer/features" },
        { name: "Employee Management", path: "/customer/features" },
        { name: "Add Package", path: "/customer/features" },
        { name: "Customers Management", path: "/customer/features" },
        { name: "Reports & Analytics", path: "/customer/features" },
        { name: "Inventory Management", path: "/customer/features" },
        { name: "Billing", path: "/customer/features" },
      ],
    },
    {
      title: "Resources",
      items: [
        { name: "Blogs", path: "/customer/blogs" },
        { name: "Case Studies", path: "/customer/case-studies" },
        { name: "Videos", path: "/customer/videos" },
      ],
    },
  ];
