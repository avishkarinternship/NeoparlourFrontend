...
const PrivacyPolicy = () => {
  ...
  const content = {
    ...
    hi: {
      ...
      sec1Text2:
        "यह प्राइवेसी पॉलिसी बताती है कि जब आप हमारे मोबाइल एप्लिकेशन और सेवाओं का उपयोग करते हैं, तब हम आपकी व्यक्तिगत जानकारी को कैसे एकत्र, उपयोग, साझा और सुरक्षित करते हैं।",

      sec1Text3:
        "प्लेटफॉर्म का उपयोग करके, आप इस प्राइवेसी पॉलिसी की शर्तों से सहमत होते हैं।",
    ...
    mr: {
      ...
      sec1Text2:
        "ही प्रायव्हसी पॉलिसी तुम्ही आमचे मोबाइल ॲप्लिकेशन आणि सेवा वापरता तेव्हा आम्ही तुमची वैयक्तिक माहिती कशी गोळा करतो, वापरतो, शेअर करतो आणि सुरक्षित ठेवतो हे स्पष्ट करते.",

      sec1Text3:
        "प्लॅटफॉर्म वापरून, तुम्ही या प्रायव्हसी पॉलिसीच्या अटींशी सहमत आहात.",
      ...
      sec13Intro:
        "आम्ही वेळोवेळी ही प्रायव्हसी पॉलिसी अपडेट करू शकतो.",
      ...
      sec14Intro:
        "कोणत्याही प्रायव्हसीशी संबंधित प्रश्नांसाठी:",
