...
const Analytics = () => {
  ...
  return (
        <div className={`flex-1 px-6 py-6 overflow-x-hidden transition-colors duration-300 ${
          isDarkMode ? 'bg-zinc-950 text-zinc-100' : 'bg-[#FAFAFA] text-gray-800'
        }`}>
          
          {/* SECTION 1: APPOINTMENTS REVENUE */}
          <div className={`border rounded-2xl p-6 shadow-md transition-all duration-300 mt-4 ${
            isDarkMode ? 'bg-zinc-900 border-zinc-800 text-zinc-100 shadow-slate-950/40 backdrop-blur-xl' : 'bg-white border-gray-100 text-gray-900'
          }`}>
            <div className={`flex flex-col md:flex-row md:items-center justify-between border-b pb-4 mb-6 gap-4 ${
              ...
              <div>
                <h2 className={`text-lg font-bold tracking-tight ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>Appointments Revenue</h2>
                <p className={`text-xs font-medium mt-0.5 ${isDarkMode ? 'text-zinc-400' : 'text-gray-500'}`}>
              ...
              <div className={`flex items-center space-x-6 text-[11px] font-bold tracking-wider md:ml-auto ${
                ...
                {['REVENUE', 'OFFER', 'STAFF'].map((tab) => (
                  <button
                    ...
                    className={`pb-2 relative transition-colors uppercase ${
                      activeTab === tab
                        ? isDarkMode ? 'text-zinc-100 font-extrabold' : 'text-gray-900 font-extrabold'
              ...
              <div className={`text-right hidden md:block md:pl-6 border-l ${
            ...
            <div className={`flex flex-wrap items-center justify-between gap-4 mb-6 p-4 rounded-xl border ${
              isDarkMode ? 'bg-zinc-800/50 border-zinc-700/60' : 'bg-gray-50/50 border-gray-100/60'
            }`}>
              <div className="flex flex-wrap items-center gap-3">
                {/* Timeframe Pills */}
                <div className={`flex gap-1.5 p-0.5 rounded-xl ${
                  isDarkMode ? 'bg-zinc-800' : 'bg-gray-100/80'
                }`}>
                    ...
                    <button
                      ...
                      className={`px-3 py-1.5 rounded-lg text-[10px] font-bold tracking-wider uppercase transition-all duration-200 ${
                        graphViewType === type
                          ...
                          : isDarkMode ? 'text-zinc-400 hover:text-zinc-100' : 'text-gray-400 hover:text-gray-600'
                      }`}
                    >
                      {type}
                    </button>
          ...
          <div className={`border rounded-2xl p-6 shadow-xs mt-8 ${
            isDarkMode ? 'bg-zinc-900 border-zinc-800 text-zinc-100' : 'bg-white border-gray-100'
          }`}>
            <div className={`flex flex-col md:flex-row md:items-center justify-between border-b pb-4 mb-6 gap-4 ${
              isDarkMode ? 'border-zinc-800' : 'border-gray-100'
            }`}>
              <div>
                <h2 className={`text-lg font-bold tracking-tight ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>Product Sales</h2>
                <p className={`text-xs font-semibold mt-0.5 ${isDarkMode ? 'text-zinc-400' : 'text-gray-400'}`}>Comprehensive product purchases revenue & timeline metrics</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              {/* Area Chart Container */}
              <div className={`border rounded-xl p-4 flex flex-col justify-between min-h-[320px] ${
                isDarkMode ? 'border-zinc-800' : 'border-gray-100/80'
              }`}>
                <div className="mb-4">
                  <h3 className={`text-xs font-bold uppercase tracking-wider ${isDarkMode ? 'text-zinc-100' : 'text-gray-900'}`}>Product Sales Revenue</h3>
                  <p className={`text-[10px] font-medium mt-0.5 ${isDarkMode ? 'text-zinc-400' : 'text-gray-400'}`}>Timeline trend distribution</p>
                </div>
                ...
                <div className={`flex items-center mt-3 text-[9px] font-bold ${isDarkMode ? 'text-zinc-400' : 'text-gray-600'}`}>
                  <span className="w-2.5 h-0.5 bg-[#ff0b01] mr-1.5" /> Core Generated Revenue Stream
                </div>
              </div>
              ...
              <div className={`border rounded-xl p-4 flex flex-col justify-between min-h-[320px] ${
                ...
                <div className="mb-4">
                  <h3 className={`text-xs font-bold uppercase tracking-wider ${isDarkMode ? 'text-zinc-100' : 'text-gray-900'}`}>Product Sales Distribution</h3>
                  <p className={`text-[10px] font-medium mt-0.5 ${isDarkMode ? 'text-zinc-400' : 'text-gray-400'}`}>Timeframe distribution matrix</p>
                </div>
