...
const CustomerTermsAndConditions = () => {
  ...
  const content = {
    ...
    hi: {
      ...
      subtitle: "ग्राहकों के लिए नियम और शर्तें",
      version: "संस्करण 1.0",
      effectiveDate: "प्रभावी तिथि: 27/05/26",
      governedBy: "भारतीय कानून द्वारा शासित",
      navRules: "बुकिंग के नियम",
      navCancel: "रद्दीकरण नीति",
      navSafety: "आपकी सुरक्षा",
      navReviews: "रेटिंग और समीक्षाएं",
    ...
    mr: {
      ...
      subtitle: "ग्राहकांसाठी नियम आणि अटी",
      version: "आवृत्ती 1.0",
      effectiveDate: "प्रभावी तारीख: 27/05/26",
      governedBy: "भारतीय कायद्यानुसार शासित",
      navRules: "बुकिंगचे नियम",
      navCancel: "रद्द करण्याचे धोरण",
      navSafety: "आपली सुरक्षितता",
      navReviews: "रेटिंग आणि पुनरावलोकने",
