...
const PrivacyPolicyScreen = () => {
  ...
  const content = {
    ...
    hi: {
      ...
      sec1Text2: "यह गोपनीयता नीति बताती है कि हम नियोपार्लर पार्टनर ऐप का उपयोग करने वाले सलून मालिकों की जानकारी कैसे एकत्र, उपयोग और साझा करते हैं।",
      sec1Text3: "पंजीकरण करके या प्लेटफॉर्म का उपयोग करके, आप इस गोपनीयता नीति से सहमत होते हैं।",
    ...
    mr: {
      ...
      sec1Text2: "हे गोपनीयता धोरण आम्ही सलून मालकांची माहिती कशी गोळा करतो, वापरतो आणि सुरक्षित ठेवतो हे स्पष्ट करते.",
      sec1Text3: "नोंदणी करून किंवा प्लॅटफॉर्म वापरून, तुम्ही या गोपनीयता धोरणाशी सहमत होता.",
