...
const CustomerTermsAndConditions = () => {
  ...
  const content = {
    ...
    hi: {
      ...
      sec3_6Title: "3.6 टर्म्स एंड प्राइवेसी कंसेंट",
      sec3_6Text: "अकाउंट बनाकर, लॉगिन करके या बुकिंग करके, आप स्पष्ट रूप से सहमत होते हैं:",
      sec3_6List1: "ये टर्म्स एंड कंडीशंस",
      sec3_6List2: "हमारी प्राइवेसी पॉलिसी (ऐप और वेबसाइट में उपलब्ध)",
      sec3_6Footer: "प्लेटफॉर्म का आपका निरंतर उपयोग इन टर्म्स और उनमें किए गए अपडेट्स की स्वीकृति माना जाएगा।",

      sec4Title: "4. बुकिंग कैसे काम करती है",
      sec4_1: "4.1 पहले सर्विसेज चुनें — टाइम स्लॉट चुनने से पहले अपनी सभी आवश्यक सर्विसेज का चयन करना अनिवार्य है। टाइम कन्फ्यूजन से बचने के लिए यह स्टेप महत्वपूर्ण है।",
      sec4_2: "4.2 स्टाइलिस्ट चयन — यदि सलून पार्टनर द्वारा इनेबल किया गया है, तो आप अपने पसंदीदा स्टाइलिस्ट का चयन कर सकते हैं। वीकेंड्स या स्पेशल डेज में यह फीचर सीमित हो सकता है।",
      sec4_3: "4.3 कन्फर्मेशन — आपकी बुकिंग केवल तभी पक्की मानी जाती है जब आपको प्लेटफॉर्म से कन्फर्मेशन नोटिफिकेशन प्राप्त होती है।",
      sec4_4: "4.5 समय पर पहुंचें — कृपया अपने कन्फर्म्ड टाइम पर सलून पहुंचें। 10 मिनट की ग्रेस पीरियड लागू होती है। इसके बाद सलून बुकिंग कैंसल कर सकता है।",
      sec4_5: "4.6 एड-ऑन सर्विसेज — यदि आप अपॉइंटमेंट के दौरान एक्स्ट्रा सर्विसेज जोड़ना चाहते हैं, तो स्टाइलिस्ट अगले कस्टमर के टाइम के अनुसार इसे एडजस्ट करेगा।",
      sec4_6: "4.7 वॉक-इन विकल्प — सलून्स वॉक-इन कस्टमर्स को भी स्वीकार करते हैं। वॉक-इन वेटिंग टाइम सलून की कतार पर निर्भर करता है।",
      sec4Tip: "टिप: बेस्ट एक्सपीरियंस के लिए, हमेशा अपना टाइम स्लॉट चुनने से पहले अपनी सभी मनपसंद सर्विसेज चुनें।",

      sec5Title: "5. प्राइसिंग एंड पेमेंट्स",
      sec5_1: "5.1 पेमेंट कैसे काम करता है — सलून सर्विसेज के लिए सभी पेमेंट्स सीधे सलून में आपकी सर्विस पूरी होने के बाद किए जाते हैं। प्लेटफॉर्म कोई पेमेंट कलेक्ट नहीं करता।",
      sec5_2: "5.2 प्राइसिंग — सर्विसेज और उनकी प्राइसेस सलून पार्टनर्स द्वारा तय की जाती हैं। डिस्प्ले की गई प्राइसेस लागू करों (जीएसटी) सहित हैं।",
      sec5_3: "5.3 पेमेंट मेथड्स — कैश, कार्ड, यूपीआई आदि पेमेंट मेथड्स सलून द्वारा तय किए जाते हैं।",
      sec5_4: "5.4 कोई प्लेटफॉर्म फीस नहीं — प्लेटफॉर्म कस्टमर्स से बुकिंग या सुविधा के लिए कोई एक्स्ट्रा चार्ज या फीस नहीं लेता है।",
      sec5_5: "5.5 प्राइस डिस्प्यूट्स — सलून में ली गई प्राइस से संबंधित कोई भी विवाद सीधे आपके और सलून पार्टनर के बीच हल किया जाना चाहिए।",
      sec5Important: "महत्वपूर्ण: आप सर्विस के बाद सीधे सलून को पेमेंट करते हैं — कैश, कार्ड या यूपीआई। कस्टमर्स के लिए प्लेटफॉर्म पूरी तरह फ्री है।",

      sec6Title: "6. कैंसिलेशन पॉलिसी",
      sec6Intro: "चूंकि सभी पेमेंट्स सीधे सलून में किए जाते हैं, इसलिए कैंसिलेशन पर कोई फाइनेंशियल पेनल्टी नहीं है। हालांकि, कृपया समय पर कैंसल करें ताकि बाकी कस्टमर्स स्लॉट बुक कर सकें।",
      thAction: "एक्शन",
      thHow: "कैसे",
      thConsequence: "नो-शो रिजल्ट",
      row1Action: "बुकिंग कैंसल करें",
      row1How: "प्लेटफॉर्म ऐप द्वारा — कभी भी",
      row1Consequence: "कोई चार्ज नहीं। स्लॉट दूसरों के लिए उपलब्ध।",
      row2Action: "टाइम बदलें (रीशेड्यूल)",
      row2How: "प्लेटफॉर्म ऐप द्वारा — कभी भी",
      row2Consequence: "कोई चार्ज नहीं। नया स्लॉट चुनें।",
      row3Action: "नो-शो (नहीं पहुंचे)",
      row3How: "ग्रेस पीरियड के बाद ऑटो-डिटेक्ट",
      row3Consequence: "नो-शो रिकॉर्ड किया जाएगा। बार-बार नो-शो करने पर अकाउंट रिस्ट्रिक्ट हो सकता है।",
      row4Action: "सलून बुकिंग कैंसल करता है",
      row4How: "प्लेटफॉर्म आपको नोटिफाई करता है",
      row4Consequence: "रीबुक करें या दूसरा सलून चुनें। आपके लिए कोई चार्ज नहीं।",
      sec6_1: "6.1 ऐप से कैंसल करें — कृपया ऐप के जरिए ही कैंसल या रीशेड्यूल करें ताकि सलून को समय पर इन्फॉर्म किया जा सके।",
      sec6_2: "6.2 बार-बार नो-शो — बार-बार नो-शो करने पर अकाउंट पर बुकिंग रिस्ट्रिक्शंस लगाए जा सकते हैं।",
      sec6_3: "6.3 सलून की अपनी पॉलिसी — इंडिविजुअल सलून्स की अपनी कैंसिलेशन पॉलिसी हो सकती है।",
      sec6GoodPractice: "गुड प्रैक्टिस: कैंसिलेशन पर कोई फाइनेंशियल पेनल्टी नहीं है, लेकिन कृपया एडवांस में कैंसल करें ताकि कोई अन्य कस्टमर स्लॉट ले सके।",

      sec7Title: "7. रिफंड्स",
      sec7Intro: "चूंकि प्लेटफॉर्म कस्टमर्स से कोई पेमेंट कलेक्ट नहीं करता है, इसलिए प्लेटफॉर्म लेवल पर रिफंड्स लागू नहीं होते।",
      sec7_1: "7.1 सर्विस रिफंड — यदि आप सर्विस से असंतुष्ट हैं, तो पेमेंट के समय सीधे सलून पार्टनर से बात करें।",
      sec7_2: "7.2 प्लेटफॉर्म का रोल — प्लेटफॉर्म कस्टमर्स और सलून के बीच मीडिएटर के रूप में हेल्प कर सकता है।",
      sec7_3: "7.3 डिस्प्यूट रेजोल्यूशन — यदि विवाद हल नहीं होता है, तो ऐप के हेल्प सेक्शन से शिकायत दर्ज करें।",

      sec8Title: "8. हेल्थ, सेफ्टी एंड एलर्जी डिस्क्लोजर",
      sec8_1: "8.1 एलर्जी इन्फॉर्म करें — सर्विस शुरू होने से पहले अपने स्टाइलिस्ट को किसी भी एलर्जी या स्किन सेंसिटिविटी की जानकारी दें।",
      sec8_2: "8.2 पैच टेस्ट — केमिकल ट्रीटमेंट (कलर, ब्लीच, केराटिन) से पहले पैच टेस्ट की रिक्वेस्ट करें।",
      sec8_3: "8.3 केमिकल ट्रीटमेंट कंसेंट — केमिकल ट्रीटमेंट बुक करके, आप स्किन सेंसिटिविटी के रिस्क को स्वीकार करते हैं।",
      sec8_4: "8.4 एडवर्स रिएक्शन — यदि सर्विस के दौरान या बाद में कोई रिएक्शन हो, तो सर्विस तुरंत रोकें और डॉक्टर से कंसल्ट करें।",
      sec8_5: "8.5 हाइजीन स्टैंडर्ड्स — सलून पार्टनर्स को हाइजीन स्टैंडर्ड्स फॉलो करना अनिवार्य है।",
      sec8Safety: "सेफ्टी टिप: सर्विस से पहले हमेशा अपने स्टाइलिस्ट को एलर्जी के बारे में बताएं। केमिकल ट्रीटमेंट के लिए पैच टेस्ट कभी न छोड़ें।",

      sec9Title: "9. रेटिंग्स एंड रिव्यूज़",
      sec9_1: "9.1 रिव्यू कौन कर सकता है — केवल वेरिफाइड बुकिंग पूरी करने वाले कस्टमर्स ही रिव्यू सबमिट कर सकते हैं।",
      sec9_2: "9.2 ऑनेस्ट रिव्यूज़ — रिव्यूज़ आपके रियल एक्सपीरियंस पर बेस्ड होनी चाहिए।",
      sec9_3: "9.3 लाइसेंस — रिव्यू सबमिट करके, आप इसे प्लेटफॉर्म पर डिस्प्ले करने की परमिशन देते हैं।",
      sec9_4: "9.4 मॉडरेशन — हम इनएप्रोप्रियेट रिव्यूज़ को हटाने का राइट रिजर्व रखते हैं।",
      sec9_5: "9.5 फेक रिव्यूज़ नहीं — फेक या पेड रिव्यूज़ सख्त मना हैं।",

      sec10Title: "10. प्रोहिबिटेड एक्टिविटीज",
      sec10Intro: "निम्नलिखित एक्टिविटीज सख्त वर्जित हैं और इसके परिणामस्वरूप अकाउंट सस्पेंड किया जा सकता है:",
      sec10Items: [
        "रजिस्ट्रेशन या बुकिंग के दौरान गलत जानकारी देना।",
        "बिना किसी इरादे के फेक बुकिंग्स करना।",
        "सलून स्टाफ के साथ प्लेटफॉर्म के बाहर डायरेक्ट बुकिंग करना।",
        "स्टाफ या स्टाइलिस्टों के साथ मिसबिहेव या एब्यूज करना।",
        "हेल्प सिस्टम का गलत इस्तेमाल करना।",
        "अपना अकाउंट किसी और के साथ शेयर करना।",
        "प्लेटफॉर्म सिस्टम को हैक या डिस्टर्ब करने का प्रयास करना।",
        "भारतीय कानून के तहत किसी भी इललीगल काम के लिए इस्तेमाल करना।"
      ],
      ...
      sec16Title: "16. प्राइवेसी और डेटा यूसेज",
    ...
    mr: {
      ...
      sec3_6Title: "3.6 टर्म्स अँड प्रायव्हसी संमती",
      ...
      sec3_6List2: "आमची प्रायव्हसी पॉलिसी (ॲप आणि वेबसाइटवर उपलब्ध)",
      ...
      sec6Title: "6. कॅन्सेलेशन पॉलिसी",
      sec6Intro: "सर्व पेमेंट थेट सलूनमध्ये होत असल्याने, बुकिंग कॅन्सल केल्यास कोणताही आर्थिक दंड नाही. तथापि, कृपया वेळेवर कॅन्सल करा जेणेकरून इतर कस्टमर्स स्लॉट बुक करू शकतील.",
      thAction: "ॲक्शन",
      thHow: "कसे",
      thConsequence: "नो-शो रिझल्ट",
      row1Action: "बुकिंग कॅन्सल करा",
      row1How: "प्लॅटफॉर्म ॲपद्वारे — कधीही",
      row1Consequence: "कोणतेही शुल्क नाही. स्लॉट इतरांसाठी मोकळा.",
      row2Action: "टाइम बदला (रीशेड्युल)",
      row2How: "प्लॅटफॉर्म ॲपद्वारे — कधीही",
      row2Consequence: "कोणतेही शुल्क नाही. नवीन स्लॉट निवडा.",
      row3Action: "नो-शो (नाही पोहोचले)",
      row3How: "ग्रेस पीरियडनंतर ऑटो-डिटेक्ट",
      row3Consequence: "नो-शो म्हणून नोंदवले जाईल. वारंवार नो-शो केल्यास खात्यावर मर्यादा येऊ शकतात.",
      row4Action: "सलून बुकिंग कॅन्सल करते",
      row4How: "प्लॅटफॉर्म तुम्हाला नोटिफाय करतो",
      row4Consequence: "रीबुक करा किंवा दुसरे सलून निवडा. तुमच्यासाठी कोणतेही शुल्क नाही.",
      sec6_1: "6.1 ॲपद्वारे कॅन्सल करा — कृपया ॲपद्वारेच कॅन्सल किंवा रीशेड्युल करा जेणेकरून सलूनला वेळेत इन्फॉर्म केले जाईल.",
      sec6_2: "6.2 वारंवार नो-शो — वारंवार नो-शो केल्यास खात्यावर बुकिंग रिस्ट्रिक्शन्स लादले जाऊ शकतात.",
      sec6_3: "6.3 सलूनची स्वतःची पॉलिसी — इंडिव्हिज्युअल सलून्सची स्वतःची कॅन्सेलेशन पॉलिसी असू शकते.",
      sec6GoodPractice: "गुड प्रॅक्टिस: बुकिंग कॅन्सल केल्यास कोणताही आर्थिक दंड नाही, पण कृपया ॲडव्हान्समध्ये कॅन्सल करा जेणेकरून इतर कस्टमर तो स्लॉट घेऊ शकतील.",

      sec7Title: "7. रिफंड्स",
      sec7Intro: "प्लॅटफॉर्म कस्टमर्सकडून कोणतेही पेमेंट कलेक्ट करत नसल्याने, प्लॅटफॉर्म लेव्हलवर रिफंड्स लागू होत नाहीत.",
      sec7_1: "7.1 सर्व्हिस रिफंड — तुम्ही सर्व्हिसवर असमाधानी असल्यास, पेमेंट करताना थेट सलून पार्टनरशी बोला.",
      sec7_2: "7.2 प्लॅटफॉर्मचा रोल — प्लॅटफॉर्म कस्टमर आणि सलूनमध्ये मीडिएटर म्हणून हेल्प करू शकते.",
      sec7_3: "7.3 तक्रार — वाद न सुटल्यास, ॲपच्या हेल्प सेक्शनमधून तक्रार नोंदवा.",

      sec8Title: "8. हेल्थ, सेफ्टी अँड ॲलर्जी डिस्क्लोजर",
      sec8_1: "8.1 ॲलर्जीची माहिती द्या — सर्व्हिस सुरू होण्यापूर्वी तुमच्या स्टायलिस्टला कोणत्याही ॲलर्जी किंवा त्वचेच्या संवेदनशीलतेची माहिती द्या.",
      sec8_2: "8.2 पॅच टेस्ट — कोणत्याही केमिकल ट्रीटमेंट (कलर, ब्लीच, केराटिन) पूर्वी पॅच टेस्टची रिक्वेस्ट करा.",
      sec8_3: "8.3 केमिकल ट्रीटमेंट संमती — केमिकल ट्रीटमेंट बुक करून, तुम्ही त्वचेच्या संवेदनशीलतेची रिस्क स्वीकारता.",
      sec8_4: "8.4 ॲडव्हर्स रीॲक्शन — सर्व्हिसदरम्यान किंवा नंतर काही त्रास झाल्यास, सर्व्हिस त्वरित थांबवा आणि डॉक्टरांचा सल्ला घ्या.",
      sec8_5: "8.5 हायजिन स्टँडर्ड्स — सलून पार्टनर्सना हायजिन स्टँडर्ड्सचे पालन करणे बंधनकारक आहे.",
      sec8Safety: "सेफ्टी टिप: सर्व्हिसपूर्वी नेहमी तुमच्या स्टायलिस्टला ॲलर्जीबद्दल सांगा. केमिकल ट्रीटमेंटसाठी पॅच टेस्ट कधीही टाळू नका.",

      sec9Title: "9. रेटिंग्स अँड रिव्ह्यूज",
      sec9_1: "9.1 रिव्ह्यू कोण करू शकते — फक्त व्हेरीफाइड बुकिंग पूर्ण केलेले कस्टमर्सच रिव्ह्यू सबमिट करू शकतात.",
      sec9_2: "9.2 ऑनेस्ट रिव्ह्यूज — रिव्ह्यूज तुमच्या रिअल एक्सपिरियन्सवर आधारित असावीत.",
      sec9_3: "9.3 लायसन्स — रिव्ह्यू सबमिट करून, तुम्ही ते दाखवण्याचे हक्क प्लॅटफॉर्मला देता.",
      sec9_4: "9.4 मॉडरेशन — अयोग्य रिव्ह्यूज हटवण्याचा हक्क आम्ही राखून ठेवतो.",
      sec9_5: "9.5 फेक रिव्ह्यूज नाही — फेक किंवा पेड रिव्ह्यूज सख्त वर्ज्य आहेत.",

      sec10Title: "10. प्रोहिबिटेड ॲक्टिव्हिटीज",
      sec10Intro: "खालील ॲक्टिव्हिटीज सख्त वर्ज्य आहेत आणि यामुळे अकाउंट सस्पेंड केले जाऊ शकते:",
      sec10Items: [
      ...
      sec16Title: "16. प्रायव्हसी आणि डेटा वापर",
